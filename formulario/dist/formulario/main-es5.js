(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormComponent = /** @class */ (function () {
                //datos: any[];
                function FormComponent(apiService, route, router) {
                    var _this = this;
                    ...
                    if (_id != null) {
                        this.apiService.getUser(_id).subscribe(function (data) {
                            _this.userData = data;
                            return _this.userData.forEach(function (userd) {
                                _this.nombre = userd.nombre,
                                    _this.apellidos = userd.apellidos,
                                    _this.edad = userd.edad,
                                    _this.dni = userd.dni,
                                    _this.cumple = userd.cumple,
                                    _this.color = userd.color,
                                    _this.sexo = userd.sexo;
                            });
                        });
                    }
                    else {
                ...
                FormComponent.prototype.onSubmit = function () {
                    ...
                    if (this._id != null) {
                        ...
                        this.apiService.addUser(this.newUser[this.nombre,
                            ...
                            this.cumple,
                            this.color,
                            this.sexo.valueOf()]).subscribe(function (data) {
                            _this.newUser = data;
                        });
                    }
                ...
                FormComponent.prototype.cerrar = function () {
                    this.router.navigate(['']);
                    event.preventDefault();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(apiService, route, router) {
                    this.apiService = apiService;
                    this.route = route;
                    this.router = router;
                    this.usersData = [];
                }
                HomeComponent.prototype.userList = function () {
                    var _this = this;
                    this.apiService.getUsers().subscribe(function (data) {
                        _this.usersData = data;
                        return _this.usersData;
                    });
                };
                HomeComponent.prototype.ngOnInit = function () {
                    this.userList();
                };
                HomeComponent.prototype.nuevoContacto = function () {
                    this.router.navigate(['/form']);
                };
                HomeComponent.prototype.actualizarContacto = function (_id) {
                    this.router.navigate(['/form/' + ("" + _id)]);
                    // , { queryParams: { '_id': _id } }
                };
                HomeComponent.prototype.borrarContacto = function (_id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApiService = /** @class */ (function () {
                ...
                //Add User
                ApiService.prototype.addUser = function (datas) {
                    var API_URL = this.endpoint + "/users";
                    var apiUser = this.http.post(API_URL, datas);
                    return apiUser;
                };
                // Get all users
                ApiService.prototype.getUsers = function () {
                    var API_URL = this.http.get(this.endpoint + "/users", { headers: this.headers });
                    return API_URL;
                };
                // Get user
                ApiService.prototype.getUser = function (_id) {
                    var API_URL = this.endpoint + "/users/" + _id;
                    var apiUser = this.http.get(API_URL, { headers: this.headers });
                    return apiUser;
                };
                // Update user
                ApiService.prototype.updateUser = function (_id, data) {
                    var API_URL = this.endpoint + "/users/" + _id;
                    var apiUser = this.http.put(API_URL, data, { headers: this.headers });
                    return apiUser;
                };
                // Delete user
                ApiService.prototype.deleteUser = function (_id) {
                    var API_URL = this.endpoint + "/users/" + _id;
